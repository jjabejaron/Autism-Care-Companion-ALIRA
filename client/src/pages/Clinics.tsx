...
export default function Clinics() {
  ...
  const isClinicOpen = (clinic: ClinicResult): boolean | null => {
    if (!clinic.opening_hours) return null;
    if (typeof clinic.opening_hours.isOpen === "function") {
      return clinic.opening_hours.isOpen() ?? null;
    }
    return null;
  };
                    ...
                    <CardContent className="p-4">
                      ...
                      {selectedClinic.rating && (
                        <div className="flex items-center gap-1.5 mb-3">
                          ...
                          {isClinicOpen(selectedClinic) !== null && (
                            <Badge
                              variant="outline"
                              className={`text-xs ml-1 ${
                                isClinicOpen(selectedClinic)
